...
export default function ExplorePage() {
  ...
  useEffect(() => {
    ...
    if (searchFilters.category && searchFilters.category !== "all") {
      filtered = filtered.filter(
        (debate) => debate.category === searchFilters.category
      );
    }
    ...
    if (searchFilters.status !== "all") {
      filtered = filtered.filter(
        (debate) => debate.status === searchFilters.status
      );
    }
    ...
    switch (searchFilters.sortBy) {
      ...
      case "most-voted":
        filtered.sort(
          (a, b) =>
            b.supportVotes + b.opposeVotes - (a.supportVotes + a.opposeVotes)
        );
        break;
      case "ending-soon":
        filtered.sort(
  ...
  return (
    <div className="min-h-screen bg-background text-foreground relative overflow-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none">
        ...
        <div
          className="absolute top-40 right-20 w-24 h-24 bg-purple-500/10 rounded-full blur-2xl animate-pulse"
          style={{ animationDelay: "2s" }}
        ></div>
        <div
          className="absolute bottom-20 left-1/3 w-40 h-40 bg-indigo-500/10 rounded-full blur-3xl animate-pulse"
      ...
      <div className="flex flex-1 justify-center px-4 py-5 lg:px-40 relative z-10 pt-16">
        ...
        >
          ...
          >
            ...
            >
              Discover and join active discussions, or browse through past
              debates.
              <span className="text-primary font-medium">
                {" "}
                Find your next intellectual challenge.
              </span>
            </motion.p>
            ...
            >
              ...
              <div className="text-center">
                <div className="text-2xl font-bold text-green-500">
                  {filteredDebates.filter((d) => d.status === "live").length}
                </div>
                <div className="text-sm text-muted-foreground">Active Now</div>
              </div>
              <div className="text-center">
                <div className="text-2xl font-bold text-blue-500">
                  {filteredDebates.reduce(
                    (sum, d) => sum + d.supportVotes + d.opposeVotes,
                    0
                  )}
                </div>
            ...
            {filteredDebates.length > 0 ? (
                      ...
                      <div className="flex flex-col md:flex-row md:items-start gap-6">
                        <div className="flex-1">
                          ...
                          <div className="flex items-center gap-3 mb-4">
                            <Badge
                              variant="secondary"
                              className="text-xs font-medium bg-blue-500/10 text-blue-600 border-blue-500/20"
                            >
                              {debate.category}
                            </Badge>
                            <Badge
                          ...
                          <div className="flex items-center gap-6 text-sm text-muted-foreground">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <span className="font-medium">
                                {debate.supportVotes + debate.opposeVotes} votes
                              </span>
                            </div>
                          </div>
                        </div>
              ...
              >
                ...
                <p className="text-muted-foreground mb-8 max-w-md mx-auto">
                  No debates match your current filters. Try adjusting your
                  search criteria or create a new debate!
                </p>
